...
class GTFSVisualizer:
    ...
    def get_route_directions(self, route_id: str):
        ...
        for _, trip in route_trips.iterrows():
            ...
            # Derive direction key from trip_id, e.g. istanbul_10_forward_1_5_1 -> forward
    ...
    def get_direction_stops(self, route_id: str, direction: str):
        ...
        trip_stops = self.stop_times[
            self.stop_times['trip_id'] == direction_trip['trip_id']
...
def main():
    ...
    try:
        ...
        direction_options = {
            f"{direction}: {headsign}": direction
            for direction, headsign in directions.items()
        }
